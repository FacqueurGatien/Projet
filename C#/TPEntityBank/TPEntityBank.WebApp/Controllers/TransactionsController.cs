...
namespace TPEntityBank.WebApp.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TransactionDate,CompteDebiteur,CompteCrediteur,Montant")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TransactionDate,CompteDebiteur,CompteCrediteur,Montant")] Transaction transaction)
        {
