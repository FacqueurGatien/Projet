...
namespace SudokuAlgo.AlgoTraqueur
{
    public static class AlgoResolveur
    {
        ...
        public static List<List<int[]>> RecupererListeIndex(Grille _grille)
        {
            ...
            int indexNum;
            if (_grille.CompterItterationTotal() > 300)
                indexNum = 6;
            else if (_grille.CompterItterationTotal() > 270)
                indexNum = 5;
            else if (_grille.CompterItterationTotal() > 240)
                indexNum = 4;
            else if (_grille.CompterItterationTotal() > 210)
                indexNum = 3;
            else
                indexNum = 2;
