...
--
-- Host: localhost    Database: db_cardgame
-- ------------------------------------------------------
...
CREATE TABLE `cardtypes` (
  ...
  `cardtype_classname` varchar(50) DEFAULT NULL,
  `cardtype_description` varchar(100) DEFAULT NULL
...
-- Dump completed on 2022-09-23  8:57:35
